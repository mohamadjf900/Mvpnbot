...
def signal_handler(sig, frame):
    ...
    stop_flag = True
    sys.exit(0)  # اجازه می‌دهد حلقه اصلی دوباره راه‌اندازی شود
...
async def main_loop():
    ...
    while not stop_flag:
        try:
            ...
            # اگر حلقه به دلیل خطا یا سیگنال متوقف شد، ۵ ثانیه صبر کن و دوباره تلاش کن
            if not stop_flag:
